...
public class Peer2 {
	...
	static String client2_location = rootDirectory + "/peer2";
	static String chunksLocation = client2_location + "/chunks";
	...
	public static void main(String[] args) {
		...
		new File(client2_location + "/chunks/").mkdirs();
	...
	public void combineChunks() {
		...
		String chunksLocation = client2_location + "/chunks";
		File[] files = new File(chunksLocation).listFiles();
		byte[] chunk = new byte[102400];
		try {
			FileOutputStream fileOutStream = new FileOutputStream(
					new File(client2_location +"/" + (files[0].getName()).split("_")[1]));
			BufferedOutputStream bufferOutStream = new BufferedOutputStream(fileOutStream);
			for (File f : files) {
